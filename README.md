Moduł uruchomi się w trybie konfiguracji, rozgłaszając swoją sieć `SUPLA-[MAC_ADDRESS]`.
...
W następnym kroku wchodzimy w przeglądarce na adres z naszej sieci lokalnej (zapisany wcześniej), ponownie podajemy dane logowania. Opcjonalnie ustawiamy nazwę urządzenia i dostępne opcje (zależne od urządzenia). Zapisujemy, klikając ZAPISZ I URUCHOM PONOWNIE.
...
- klikamy 7 razy (roleta - przyciskiem w górę, ilość kliknięć można zmienić)
